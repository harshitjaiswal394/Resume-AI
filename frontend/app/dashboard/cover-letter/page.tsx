      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <header className="flex items-center justify-between relative z-10">
          <div className="flex items-center gap-6">
            <Button variant="outline" size="icon" onClick={() => router.back()} className="rounded-2xl h-14 w-14 bg-white border-slate-100 shadow-sm hover:shadow-md transition-all">
              <ChevronLeft className="h-6 w-6 text-slate-600" />
            </Button>
            <div>
               <div className="flex items-center gap-3 mb-1">
                 <Badge className="bg-indigo-600 text-white border-0 font-black text-[10px] uppercase tracking-tighter px-2 py-0.5 rounded-md shadow-lg shadow-indigo-100">AI Powered</Badge>
                 <span className="h-1.5 w-1.5 rounded-full bg-indigo-200" />
                 <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">v2.0 Beta</span>
               </div>
              <h1 className="text-5xl font-black text-slate-900 tracking-tighter leading-none">Smart Cover Letter</h1>
            </div>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
          ...
          <div className="lg:col-span-5 space-y-8">
            <Card className="border-0 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] rounded-[3rem] bg-white/70 backdrop-blur-3xl overflow-hidden ring-1 ring-white/20">
              <CardHeader className="p-10 pb-4">
                ...
                <CardDescription className="text-slate-500 font-medium text-base ml-14">Configure your generation source</CardDescription>
              </CardHeader>
              <CardContent className="p-10 pt-6 space-y-8">
                <div className="space-y-3">
                  ...
                  <Select value={selectedResumeId} onValueChange={setSelectedResumeId}>
                    <SelectTrigger className="h-20 rounded-3xl border-slate-100 bg-white shadow-sm ring-1 ring-slate-100 focus:ring-4 focus:ring-indigo-50 hover:border-indigo-100 transition-all text-left px-6">
                ...
                <Button 
                  ...
                  className="w-full h-20 rounded-[2rem] bg-indigo-600 hover:bg-violet-600 text-white font-black text-xl shadow-2xl shadow-indigo-100 hover:shadow-violet-200 transition-all active:scale-[0.98] group overflow-hidden relative"
                >
          ...
          <div className="lg:col-span-7 space-y-8">
            <Card className="border-0 shadow-[0_48px_80px_-16px_rgba(99,102,241,0.06)] rounded-[3.5rem] bg-white ring-1 ring-slate-50 overflow-hidden min-h-[700px] flex flex-col">
              <CardHeader className="p-12 pb-6 flex flex-row items-center justify-between border-b border-indigo-50/50 bg-indigo-50/10">
                <div>
                ...
                {content && (
                  <div className="flex gap-3">
                    <Button variant="outline" size="icon" onClick={copyToClipboard} className="h-12 w-12 rounded-2xl border-indigo-100 hover:bg-indigo-50 hover:text-indigo-600 transition-all">
                      <Copy className="h-5 w-5" />
                    </Button>
                    <Button variant="outline" size="icon" onClick={handleDownloadPDF} className="h-12 w-12 rounded-2xl border-indigo-100 hover:bg-indigo-50 hover:text-indigo-600 transition-all">
                  ...
                  {content ? (
                    ...
                    >
                      <Textarea 
                        ...
                        className="h-full min-h-[550px] border-none focus-visible:ring-0 p-0 text-slate-700 leading-relaxed text-lg font-medium resize-none selection:bg-indigo-50"
                      />
                    </motion.div>
                  ) : (
