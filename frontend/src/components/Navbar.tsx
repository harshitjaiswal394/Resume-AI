        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {user ? (
              ...
              <>
                <Button variant="ghost" onClick={() => openAuth('signin')} className="font-bold text-small sm:text-body">
                  Sign in
                </Button>
                <Button className="rounded-xl px-4 sm:px-6 font-bold shadow-lg shadow-brand-500/20 text-small sm:text-body" onClick={() => openAuth('signup')}>
